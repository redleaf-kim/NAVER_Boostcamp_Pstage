import os
from albumentations.augmentations.transforms import ChannelShuffle, ColorJitter, HueSaturationValue, RGBShift
import torch
...
class Config:
    def __init__(self, args, main_dir='/opt/ml/', mode='train'):
        ...
        self.unlabeld_folder = self.data_dir / 'unlabeled'
        ...
        self.weight_path = 'checkpoints/tf_efficientnet_b3_ns_v5_test/Fold-1_best_loss.pth.tar'
        ...
        # uda
        self.ratio_mode = args.ratio_mode
...
class InferConfig:
    def __init__(self, args, main_dir='/opt/ml/', mode='eval'):
        ...
        # self.image_folder = self.data_dir / mode / 'images'
        self.image_folder = self.data_dir / mode / 'cropped_images'
